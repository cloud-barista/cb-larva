...
type CloudAdaptiveNetworkServiceClient interface {
	...
	SayHello(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*wrappers.StringValue, error)
	...
	GetCLADNetList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CLADNetSpecifications, error)
...
func (c *cloudAdaptiveNetworkServiceClient) SayHello(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*wrappers.StringValue, error) {
...
func (c *cloudAdaptiveNetworkServiceClient) GetCLADNetList(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CLADNetSpecifications, error) {
...
type CloudAdaptiveNetworkServiceServer interface {
	...
	// Pass in nothing and
	// return a say-hello message.
	SayHello(context.Context, *empty.Empty) (*wrappers.StringValue, error)
	// Used to get a Cloud Adaptive Network specification.
	// Pass in an ID of Cloud Adaptive Networkand
	// return a Cloud Adaptive Network specification.
	...
	// Pass in nothing and
	// return a list of Cloud Adaptive Network specifications.
	GetCLADNetList(context.Context, *empty.Empty) (*CLADNetSpecifications, error)
	// Used to create a new Cloud Adaptive Network.
	// Pass in a specification of Cloud Adaptive Network and
	// return the specification of Cloud Adaptive Network.
...
func (UnimplementedCloudAdaptiveNetworkServiceServer) SayHello(context.Context, *empty.Empty) (*wrappers.StringValue, error) {
...
func (UnimplementedCloudAdaptiveNetworkServiceServer) GetCLADNetList(context.Context, *empty.Empty) (*CLADNetSpecifications, error) {
...
func _CloudAdaptiveNetworkService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudAdaptiveNetworkServiceServer).SayHello(ctx, req.(*empty.Empty))
	}
...
func _CloudAdaptiveNetworkService_GetCLADNetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudAdaptiveNetworkServiceServer).GetCLADNetList(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
