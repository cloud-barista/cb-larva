...
###########################################################
# Example: Deploy and Access the Kubernetes Dashboard     #
###########################################################

echo ""
echo =================================================
echo "== Deploy and Access the Kubernetes Dashboard"
echo =================================================

# Step 1: Deploying the Dashboard UI by customized YAML (using NodePort)
echo ""
echo "== Step 1: Deploying the Dashboard UI by customized YAML (using NodePort)"

cat <<EOF >./recommended-with-nodeport.yaml
...
echo "kubectl apply -f recommended-with-nodeport.yaml"
sleep 1
kubectl apply -f recommended-with-nodeport.yaml


# Step 2: Creating a Service Account
echo ""
echo "== Step 2: Creating a Service Account"
...
echo "kubectl apply -f dashboard-adminuser.yaml"
sleep 1
kubectl apply -f dashboard-adminuser.yaml

# Step 3: Creating a ClusterRoleBinding
echo ""
echo "== Step 3: Creating a ClusterRoleBinding"

cat <<EOF >./dashboard-admin-rbac.yaml
apiVersion: rbac.authorization.k8s.io/v1
kind: ClusterRoleBinding
metadata:
  name: admin-user
...
echo "kubectl apply -f dashboard-admin-rbac.yaml"
sleep 1
